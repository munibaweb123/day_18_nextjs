...
export default function CurrencyConverter() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-background bg-amber-700">
        ...
        <CardContent>
          {loading ? (
            <div className="flex justify-center">
              <ClipLoader className="w-6 h-6 text-amber-700" />
            </div>
          ) : error ? (
            <div className="text-amber-700 text-center">{error}</div>
          ) : (
            <div className="grid gap-4">
              {/* Amount input and source currency selection */}
              <div className="grid grid-cols-[1fr_auto] items-center gap-2 text-amber-700">
                ...
                <div className="grid grid-cols-[1fr_auto] items-center gap-2 text-amber-700">
                  <Input
                    ...
                    className="w-full border-amber-700"
                    id="from"
                  />
                  <Select
